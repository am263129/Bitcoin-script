...
def network_graph(yearRange, AccountToSearch):
    ...
    for index in range(0,len(edge1)):
        # edge1['Datetime'][index] = edge1['Date'][index][5:] + "/" + edge1['Date'][index][0:4]
        # print("KKK",edge1['Datetime'][index].year)
        # if int(edge1['Date'][index][5:])<yearRange[0] or int(edge1['Date'][index][5:])>yearRange[1]:
        #     # print(yearRange[1])
...
app.layout = html.Div([
    #########################Title
    html.Div([html.H1("Bitcoin Transfer")],
             className="row",
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            **Address To Search**
                            ...
                            Input the address to visualize.
                            """)),
